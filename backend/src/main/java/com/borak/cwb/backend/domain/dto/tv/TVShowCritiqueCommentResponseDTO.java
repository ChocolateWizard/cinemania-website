...
public class TVShowCritiqueCommentResponseDTO implements DTO {
    ...
    @JsonView(JsonVisibilityViews.Lite.class)
    private TVShowCritiqueUserResponseDTO user;

    public TVShowCritiqueCommentResponseDTO() {
    }

    public TVShowCritiqueCommentResponseDTO(Long id, String content, LocalDateTime createdAt, Integer numberOfLikes, Integer numberOfDislikes, TVShowCritiqueUserResponseDTO user) {
        this.id = id;
    ...
    public TVShowCritiqueUserResponseDTO getUser() {
        return user;
    }

    public void setUser(TVShowCritiqueUserResponseDTO user) {
        this.user = user;
    }
