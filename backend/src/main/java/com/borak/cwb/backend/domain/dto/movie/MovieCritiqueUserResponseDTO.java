...
public class MovieCritiqueUserResponseDTO implements DTO {
    ...
    public MovieCritiqueUserResponseDTO() {
    }

    public MovieCritiqueUserResponseDTO(String profileName, String profileImageUrl) {
