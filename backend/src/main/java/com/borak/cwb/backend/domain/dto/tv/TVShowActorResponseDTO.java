...
public class TVShowActorResponseDTO implements DTO {
    ...
    @JsonView(JsonVisibilityViews.Lite.class)
    private List<TVShowActorRoleResponseDTO> roles = new ArrayList<>();
    ...
    public List<TVShowActorRoleResponseDTO> getRoles() {
        return roles;
    }

    public void setRoles(List<TVShowActorRoleResponseDTO> roles) {
        this.roles = roles;
    }
