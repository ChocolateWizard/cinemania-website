...
public class UserCountryResponseDTO implements DTO {
    ...
    public UserCountryResponseDTO() {
    }

    public UserCountryResponseDTO(Long id, String name, String officialStateName, String code) {
        this.id = id;
        this.name = name;
